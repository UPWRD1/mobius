...
impl Player {
    ...
    pub fn update(&mut self, rl: &RaylibHandle, dt: f32) {
        ...
        //    PLAYER_CAMERA_MIN_CLAMP * DEG2RAD as f32,
        //    PLAYER_CAMERA_MAX_CLAMP * DEG2RAD as f32,
        //);
        ...
        self.cam.position.x += ((f32::sin(self.pitch) * (direction[1] as usize) as f32
            ...
            + f32::cos(self.pitch) * (direction[2] as usize) as f32)
            * self.move_speed)
            * dt;
        ...
        self.cam.position.z += ((f32::cos(self.pitch) * (direction[1] as usize) as f32
            ...
            - f32::sin(self.pitch) * (direction[2] as usize) as f32)
            * self.move_speed)
            * dt;
    }
}
